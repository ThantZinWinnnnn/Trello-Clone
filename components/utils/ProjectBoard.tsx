  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <CreateNewBoardModal>
          <Button className="bg-blue-600 hover:bg-blue-800 dark:bg-white dark:hover:bg-slate-100 text-white dark:text-slate-900 font-medium px-6 py-2 shadow-sm rounded-lg transition-all active:scale-[0.98]">
            Create New Board
          </Button>
        </CreateNewBoardModal>
      </div>
          ...
          isLoading ? skeletonBoards :
            memoizedBoards?.map((board) => (
              ...
              >
                ...
                <p className="text-slate-900 dark:text-white font-semibold text-base truncate pr-6 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                  {board.name}
                </p>
