...
export default function Error({
  ...
  return (
    <main className="flex min-h-full items-center justify-center w-full bg-white px-6 py-24 sm:py-32 lg:px-8 ">
      <div className="text-center">
        <p className="text-base font-semibold text-red-600">400</p>
